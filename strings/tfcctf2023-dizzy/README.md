...
'''
### *** It conveys the idea that the number of empty spaces at the beginning of the project does not need to be fixed manually, as the project itself determines the required number based on the input.